...
@Entity @Table(name="contacto_urgencia",
...
public class ContactoUrgencia {
  ...
  @Column(length=60) private String relacion;
  @ManyToOne @JoinColumn(name="localidad_id", foreignKey=@ForeignKey(name="fk_contacto_localidad"))
  private Localidad localidad;
  @ManyToOne(optional=false) @JoinColumn(name="persona_id", nullable=false,
